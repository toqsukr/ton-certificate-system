...
export function loadAddManagerRequest(slice: Slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 11113229) { throw Error('Invalid prefix'); }
...
export function loadRemoveManagerRequest(slice: Slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 13833075) { throw Error('Invalid prefix'); }
    const _manager = sc_0.loadAddress();
...
export function loadOrganization$Data(slice: Slice) {
    ...
    const _wallet_whitelist = Dictionary.load(Dictionary.Keys.Address(), Dictionary.Values.Address(), sc_0);
    return { $$type: 'Organization$Data' as const, content: _content, owner: _owner, next_index: _next_index, manager_next_index: _manager_next_index, wallet_whitelist: _wallet_whitelist };
}
...
export function loadTupleOrganization$Data(source: TupleReader) {
    ...
    const _wallet_whitelist = Dictionary.loadDirect(Dictionary.Keys.Address(), Dictionary.Values.Address(), source.readCellOpt());
    return { $$type: 'Organization$Data' as const, content: _content, owner: _owner, next_index: _next_index, manager_next_index: _manager_next_index, wallet_whitelist: _wallet_whitelist };
}
...
export function storeTupleOrganization$Data(source: Organization$Data) {
    ...
    builder.writeCell(source.wallet_whitelist.size > 0 ? beginCell().storeDictDirect(source.wallet_whitelist, Dictionary.Keys.Address(), Dictionary.Values.Address()).endCell() : null);
    return builder.build();
}
...
export function loadCertificateNFT$Data(slice: Slice) {
    ...
    const _content = sc_0.loadRef();
    return { $$type: 'CertificateNFT$Data' as const, deployed: _deployed, collection: _collection, owner: _owner, index: _index, content: _content };
}
...
export function loadManagerNFT$Data(slice: Slice) {
    ...
    const _index = sc_0.loadIntBig(257);
    const _content = sc_0.loadRef();
    return { $$type: 'ManagerNFT$Data' as const, deployed: _deployed, collection: _collection, owner: _owner, index: _index, content: _content };
}
...
export function loadNftDeploy(slice: Slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 3082862875) { throw Error('Invalid prefix'); }
    const _index = sc_0.loadUintBig(256);
    const _owner = sc_0.loadAddress();
    const _content = sc_0.loadRef();
...
export function loadRequestNftDeploy(slice: Slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 3200183706) { throw Error('Invalid prefix'); }
    const _owner = sc_0.loadAddress();
    const _content = sc_0.loadRef();
...
export function loadOrgInitRequest(slice: Slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 712191329) { throw Error('Invalid prefix'); }
    const _content = sc_0.loadRef();
...
async function Organization_init(content: Cell, owner: Address) {
    const __code = Cell.fromHex('');
...
const Organization_types: ABIType[] = [
    ...
    {"name":"AddManagerRequest","header":11113229,"fields":[{"name":"manager","type":{"kind":"simple","type":"address","optional":false}},{"name":"content","type":{"kind":"simple","type":"cell","optional":false}}]},
    {"name":"RemoveManagerRequest","header":13833075,"fields":[{"name":"manager","type":{"kind":"simple","type":"address","optional":false}}]},
    {"name":"Organization$Data","header":null,"fields":[{"name":"content","type":{"kind":"simple","type":"cell","optional":false}},{"name":"owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"next_index","type":{"kind":"simple","type":"uint","optional":false,"format":256}},{"name":"manager_next_index","type":{"kind":"simple","type":"uint","optional":false,"format":256}},{"name":"wallet_whitelist","type":{"kind":"dict","key":"address","value":"address"}}]},
    ...
    {"name":"CertificateNFT$Data","header":null,"fields":[{"name":"deployed","type":{"kind":"simple","type":"bool","optional":false}},{"name":"collection","type":{"kind":"simple","type":"address","optional":false}},{"name":"owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"index","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"content","type":{"kind":"simple","type":"cell","optional":false}}]},
    {"name":"ManagerNFT$Data","header":null,"fields":[{"name":"deployed","type":{"kind":"simple","type":"bool","optional":false}},{"name":"collection","type":{"kind":"simple","type":"address","optional":false}},{"name":"owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"index","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"content","type":{"kind":"simple","type":"cell","optional":false}}]},
    ...
    {"name":"NftDeploy","header":3082862875,"fields":[{"name":"index","type":{"kind":"simple","type":"uint","optional":false,"format":256}},{"name":"owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"content","type":{"kind":"simple","type":"cell","optional":false}}]},
    {"name":"RequestNftDeploy","header":3200183706,"fields":[{"name":"owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"content","type":{"kind":"simple","type":"cell","optional":false}}]},
    ...
    {"name":"OrgInitRequest","header":712191329,"fields":[{"name":"content","type":{"kind":"simple","type":"cell","optional":false}},{"name":"wallet","type":{"kind":"simple","type":"address","optional":false}}]},
...
const Organization_getters: ABIGetter[] = [
    ...
    {"name":"get_nft_content","methodId":68445,"arguments":[{"name":"_","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"individual_content","type":{"kind":"simple","type":"cell","optional":false}}],"returnType":{"kind":"simple","type":"cell","optional":false}},
...
export class Organization implements Contract {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: AddManagerRequest | RemoveManagerRequest | RequestNftDeploy | null) {
        
        let body: Cell | null = null;
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'AddManagerRequest') {
            body = beginCell().store(storeAddManagerRequest(message)).endCell();
        }
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'RemoveManagerRequest') {
